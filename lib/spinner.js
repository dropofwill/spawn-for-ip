      ...
      wait: {
        $enter: function (cb) {
          ...
          function _waitForBind() {
            ...
            spinner.logger.log('checking status of port ' + spinner.port, 'seconds left:', spinner.wait.tries / 2);
      ...
      faulted: {
        ...
        start: function (cb) {
          ...
          if (delta < options.faultTimeout) {
            ...
            spinner.logger.log('fault timeout expired, trying to restart');
        ...
        $exit: function (cb) {
          spinner.logger.log('clearing fault state');
      ...
      started: {
        ...
        term: function (cb) {
          ...
          if (spinner.started.lastTerminationTime) {
            ...
            spinner.logger.info('Last termination was ' + delta + ' seconds ago');
